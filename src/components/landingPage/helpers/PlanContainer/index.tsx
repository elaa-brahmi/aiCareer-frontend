...
const PlanContainer:React.FC<PlanContainer> = async({user}) =>{
    return (
    <div className="w-[280px] h-[189px] rounded-xl border border-gray-200 bg-white shadow-sm p-6 flex flex-col justify-between">
      ...
      <div>
        <h2 className="text-2xl font-bold text-gray-900">{user.plan}</h2>
        <p className="text-sm text-gray-500 mt-1">Limited features</p>
      </div>
    </div>
  );
}
